...
## Hướng tôi nhắm: kỹ sư AI/ML và kỹ sư phàn mềm

Vì sao: trước hết chúng ta đang dần bước vào kỷ nguyên AI AGENT, một nơi mà các công cụ tiên tiến đang dần dần bước vào cuộc sống của chúng ta, hầu hết các công ty đang sử dụng AI vào công việc nếu chúng ta biết dử dụng chúng thì sẽ là một lợi thế cực lớn để phát triển, lý do thứ 2 là tôi đang rất hứng thú về các phần mềm, hệ thống của chúng vận hành như thế nào đặc biệt là về mảng game mặc dù không phải môt tay chơi chuyên nghiệp nhưng tôi lại có khát khao muốn biết làm cách nào để tạo ra được những cử chỉ, cảm xúc hay những hoạt cảnh xung quanh, chúng được vận hành bằng cách nào?. và hơn hết tôi đang nhắm đến việc kết hợp cả 2 ngành này lại với nhau thì sẽ tạo được một sản phẩm có thể cạnh tranh được với những ông lớn trong mảng công nghệ hay không?  

## Bảng năng lực rút từ ba tin tuyển dụng

| Lớp | Tin 1 | Tin 2 | Tin 3 | Tôi đã có? |
|---|---|---|---|---|
| Kiến thức | • Là sinh viên năm cuối hoặc đã tốt nghiệp Đại học chưa quá 02 năm, ưu tiên các chuyên ngành Công nghệ thông tin hoặc các chương trình đào tạo liên quan đến lập trình và kỹ thuật phần mềm<br>• Nắm vững kiến thức nền tảng về cấu trúc dữ liệu, thuật toán và thành thạo ít nhất một ngôn ngữ lập trình (Java, C++, Python,...) | • Thành thạo JavaScript hoặc C#, có nền tảng tốt về lập trình hướng đối tượng (OOP).<br>• Có kiến thức cơ bản về cấu trúc dữ liệu và thuật toán.<br>• Sinh viên năm 3, năm cuối hoặc mới tốt nghiệp chuyên ngành Công nghệ Thông tin hoặc các ngành liên quan | ● Tốt nghiệp Đại học (hệ chính quy) đúng chuyên ngành: Công nghệ thông tin, Khoa học máy tính, Hệ thống thông tin, Trí tuệ nhân tạo hoặc liên quan (không xét hệ Cao đẳng).<br>● Đã hoàn thành khóa đào tạo chuyên sâu về AI (Machine Learning, Prompt Engineering, Generative AI...)<br>● Có kiến thức lập trình Python (bắt buộc); biết thêm SQL, JavaScript là lợi thế.<br>● Hiểu biết về các nền tảng automation/workflow (n8n, Power Automate, Make, Zapier, UiPath...).<br>● Có kiến thức cơ bản về API và tích hợp hệ thống.<br>● Biết sử dụng công cụ trực quan hóa dữ liệu/BI (Power BI, Looker Studio) hoặc Excel nâng cao (Power Query, Pivot Table). | chưa |
| Kiến thức | • Nắm vững kiến thức nền tảng về cấu trúc dữ liệu, thuật toán và thành thạo ít nhất một ngôn ngữ lập trình (Java, C++, Python,...) | • Thành thạo JavaScript hoặc C#, có nền tảng tốt về lập trình hướng đối tượng (OOP).<br>• Có kiến thức cơ bản về cấu trúc dữ liệu và thuật toán.<br>• Sinh viên năm 3, năm cuối hoặc mới tốt nghiệp chuyên ngành Công nghệ Thông tin hoặc các ngành liên quan |● Đã hoàn thành khóa đào tạo chuyên sâu về AI (Machine Learning, Prompt Engineering, Generative AI...)<br>● Có kiến thức lập trình Python (bắt buộc); biết thêm SQL, JavaScript là lợi thế.<br>● Hiểu biết về các nền tảng automation/workflow (n8n, Power Automate, Make, Zapier, UiPath...)<br>● Có kiến thức cơ bản về API và tích hợp hệ thống.<br>● Biết sử dụng công cụ trực quan hóa dữ liệu/BI (Power BI, Looker Studio) hoặc Excel nâng cao (Power Query, Pivot Table). | chưa |
| Thái độ | • Thái độ cầu tiến, ham học hỏi, năng động và sẵn sàng thử thách | • Có tư duy logic, khả năng giải quyết vấn đề và tinh thần học hỏi cao. | ● Tư duy logic tốt, chủ động học hỏi, khả năng tự nghiên cứu công nghệ mới. | chưa |
| Công cụ | ● Ngôn ngữ lập trình | ● Ngôn ngữ lập trình | ● Biết sử dụng công cụ trực quan hóa dữ liệu/BI (Power BI, Looker Studio) hoặc Excel nâng cao (Power Query, Pivot Table), và ngôn ngữ lập trình. | chưa |
## Ba tin tuyển dụng

| # | Công ty | Vị trí | Đường dẫn | Ngày truy cập |
|---|---|---|---|---|
| 1 | Công Ty TNHH SAMSUNG SDS VietNam  | Software Engineer | https://www.topcv.vn/viec-lam/software-internship-program-2026/2292472.html?ta_source=ButtonCopyToClipboardInJobDetail&u_sr_id=zECkcAKptSPPEEJOtPpCZe4iOYa4tWsC4xMnhmAh_1789388751 | 12/09/2026 |
| 2 | Công Ty Cổ Phần Falcon Technology | Backend Developer | https://www.topcv.vn/viec-lam/javascript-fresher-15-20m-net-upto-18-thang-luong-f37/2233552.html?ta_source=ButtonCopyToClipboardInJobDetail&u_sr_id=zECkcAKptSPPEEJOtPpCZe4iOYa4tWsC4xMnhmAh_1789389133 | 12/09/2026  |
| 3 | Công Ty Cổ Phần Vận Tải Biển Container Thái Bình Dương | DevOps Engineer | https://www.topcv.vn/viec-lam/ai-automation-specialist/2295788.html?ta_source=ButtonCopyToClipboardInJobDetail&u_sr_id=zECkcAKptSPPEEJOtPpCZe4iOYa4tWsC4xMnhmAh_1789389346 | 12/09/2026  |
